...
fun! s:set_syntax_highlighting()
  ...
  call s:HL("sedST", s:purple, "", s:bold)
  call s:HL("sedFlag", s:purple, "", s:bold)
  call s:HL("sedRegexp47", s:pink, "", "")
  call s:HL("sedRegexpMeta", s:blue, "", s:bold)
  call s:HL("sedReplacement47", s:olive, "", "")
  call s:HL("sedReplaceMeta", s:orange, "", s:bold)
  call s:HL("sedAddress", s:pink, "", "")
  call s:HL("sedFunction", s:aqua, "", s:bold)
  call s:HL("sedBranch", s:green, "", s:bold)
  call s:HL("sedLabel", s:green, "", s:bold)
